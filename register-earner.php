...
if (isset($_POST['submit'])) {   
    ...
    elseif (empty($email)) {
       $error = 'Email fild cannot be empty';
        ...
        $sqlEarnerWallet = 'INSERT INTO earnerwallet ( userId) VALUES (:userId)';
        ...
        $body_1 .= '<h2 style="margin:10px 0">Hi investor,'.' '.$fullName.'</h2>';
...
;
        ...
        if ($rowUser) {
            ...
            $body_2 .= '<p> First Name : '.$fullName_2.'</p>';             
                ...
                <form id="registerForm" class="space-y-6" method="POST">
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input type="text" id="referererUserName" name="referererUserName" value="<?php echo $ref;?>"
                                class="pl-10 input-focus w-full px-4 py-3 rounded-lg border border-gray-300 focus:outline-none focus:border-blue-500 transition duration-300"
