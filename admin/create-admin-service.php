                ...
                <form class="space-y-4" method="POST">
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div>
                            ...
                            <input type="text" placeholder="e.g bg-blue-100" name="platformBg" required
                                class="w-full px-4 py-2 border rounded-md focus:outline-none focus:ring focus:ring-blue-300" />
                        </div>
                        <div>
                        ...
                        <div>
                            ...
                            <input type="text" placeholder="e.g fas fa-star" name="icon" required
                                class="w-full px-4 py-2 border rounded-md focus:outline-none focus:ring focus:ring-blue-300" />
                        </div>
                        <div>
                            <label class="block text-gray-700 text-sm mb-1">Icon Background</label>
                            <input type="text" placeholder="e.g text-red-100" name="iconBg" required
                                class="w-full px-4 py-2 border rounded-md focus:outline-none focus:ring focus:ring-blue-300" />
                        </div>
                        <div>
                        ...
                        <div>
                            ...
                            <input type="text" placeholder="e.g text-blue-500" name="highLightColour" required
                                class="w-full px-4 py-2 border rounded-md focus:outline-none focus:ring focus:ring-blue-300" />
                        </div>
                        <div>
