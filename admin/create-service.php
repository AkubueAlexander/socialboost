<?php
    ...
    $sql = 'INSERT INTO service (title, advDes, earnerDes,advPrice, earnerPrice,per, platform, platformBg, platformColour,
     imgUrl, imgBg, icon, iconBg, iconColour, rating, ratingCount, highLight, highLightColour, highLightBg, category) 
                ...
                <form class="space-y-4" method="POST">
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div>
                            ...
                            <input type="text"  placeholder="e.g review" name="category"                                
                                class="w-full px-4 py-2 border rounded-md focus:outline-none focus:ring focus:ring-blue-300" />
                        </div>
